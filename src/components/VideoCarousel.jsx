        ...
        onUpdate: () => {
            ...
            if(progress != currentProgress){
                ...
                gsap.to(videoDivRef.current[videoId],{
                    width: window.innerWidth < 760? '10vw' : window.innerWidth <120? '10vw' : '4vw'
                })
            ...
            <div className="video-carousel_container">
              <div className="w-full h-full rounded-3xl overflow-hidden bg-black">
                <video
                  ...
                  onPlay={() => {
                    setVideo((prevVideo) => ({ ...video, isPlaying: true }));
                  }}
              ...
              <div className="absolute top-12 left-[5%] z-10">
                {list.textLists.map((text) => (
                  <p key={text} className="text-sm md:text-2xl xl:text-xl font-medium">
                    {text}
                  </p>
                ))}
              </div>
